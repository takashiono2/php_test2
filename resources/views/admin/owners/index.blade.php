                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="md:px-4 py-3">
                                        <button onclick="location.href='{{ route('admin.owners.edit',['owner'=> $owner->id ]) }}'" class="text-white bg-indigo-400 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-400 rounded ">編集</button>
                                    </td>
                                    <form method="post" id="delete_{{ $owner->id }}" action="{{ route('admin.owners.destroy',['owner'=> $owner->id ]) }}"><!--methodとactionを設定destroyにする、id＝"delete_idを指定"-->
                                        @csrf
                                        @method('delete')
                                        <td class="md:px-4 py-3">{{-- data-idを加える --}}
